# home_page/management/commands/seed_partners.py
import os
import json
from django.core.management.base import BaseCommand
from home_page.models import Partner
from django.conf import settings

class Command(BaseCommand):
    help = "Seed Partner items from JSON file"

    def handle(self, *args, **kwargs):
        # Пайдо кардани роҳи пурраи файли JSON
        json_path = os.path.join(settings.BASE_DIR, "home_page/seed/partners.json")
        ...
        # Хориҷ кардани ҳамаи Partner-ҳои қаблӣ
        ...
        self.stdout.write(self.style.SUCCESS(f"{created_count} Partner items seeded successfully!"))
